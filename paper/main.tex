...
i.e.\ no single vendor's model is uniquely best on hard problems; Gemini is ahead by $\approx$8
points while Claude and Codex are within one problem of each other. \textsuperscript{\S}Claude's first run was
interrupted at 122/150 problems; we completed the remaining 28 (22 passed) so every teacher is
scored on the same 150, giving Claude a fair 69\% (104/150) --- up from an incomplete-run 67\%
(82/122). $^{\ddagger}$Gemini's competition run hit the same class of infrastructure artifact as
